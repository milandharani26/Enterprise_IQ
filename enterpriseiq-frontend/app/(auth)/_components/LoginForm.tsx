    ...
    <motion.div variants={wrap} initial="hidden" animate="visible" className="w-full">
      ...
      <div className="relative rounded-2xl p-8 overflow-hidden bg-card/40 border border-border">
        ...
        <motion.div variants={item} className="mb-7">
          ...
          <p className="text-sm mt-1 text-muted-foreground">Sign in to continue to <span className="text-foreground font-semibold">EnterpriseIQ</span></p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <motion.div variants={item} className="flex justify-end">
            <a href="#" className="text-xs transition-colors underline underline-offset-2 text-muted-foreground hover:text-foreground">
              Forgot password?
            </a>
          </motion.div>
